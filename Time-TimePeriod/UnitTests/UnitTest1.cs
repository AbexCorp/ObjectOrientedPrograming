...
namespace UnitTests
{
    ...
    public class TimePeriodStructUnitTests
    {
        ...
        [DataRow(00,00,00,  01,01,00,   01,01,00)]
        [DataRow(00,00,00,  01,01,01,   01,01,01)]
        [DataRow(00,00,00,  26,54,37,   26,54,37)]
        [DataRow(12,30,15,  05,29,45,   18,00,00)]
        [DataRow(58,10,38,  02,22,02,   60,32,40)]
        ...
        [DataRow(00,00,00,  01,00,00,   00,00,00)]
        ...
        [DataRow(12,00,00,  26,54,37,   00,00,00)]
        [DataRow(12,30,15,  05,29,45,   07,00,30)]
        [DataRow(58,10,38,  02,22,02,   55,48,36)]
